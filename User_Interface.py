...
class Example(Frame):
    ...
    def initUI(self):
        ...
        self.pop_up_window = Button(self, text='Plot Graph',
                                    command=lambda: openNewWindow(self.root, xls_file_with_correction))
        self.pop_up_window.pack(side=RIGHT)
        self.pop_up_window['state'] = 'disable'
...
def openNewWindow(root, save_directory):
    if not save_directory:
        graph_plot_gui = GUI_Second_Window.GUI(root, save_directory)
    else:
